...
export default function ModuleCard(props: Props) {
  ...
  return (
    <div className="flex md:flex-row gap-1 flex-col justify-center md:justify-between md:items-center md:gap-16 bg-[#424242] rounded-2xl py-4 md:py-8 md:px-32 px-4 font-articulat md:h-85 xl:w-[895.146px] 2xl:w-[1010.98px] w-[287.422px]">
