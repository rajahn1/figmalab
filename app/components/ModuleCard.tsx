...
export default function ModuleCard(props: Props) {
  ...
  return (
    <div className="flex justify-between items-center gap-16 bg-[#424242] rounded-2xl py-8 px-32 font-articulat h-85 xl:w-[1010.98px]">
      ...
      <div className="flex flex-col gap-1 justify-center xl:text-base lg:text-sm">
